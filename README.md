...
Hope Archive 首先是为**已经在使用 Hope，并希望把自己的记录长期保存到本地的人**做的。

它不是一个新的日记平台，也不是我推荐别人开始使用 Hope 的理由。对我而言，它首先是一个归档工具：把已经留在 Hope 云端的文字、图片和其他记录带回自己的电脑，整理成真正属于自己的档案。

如果你从未使用过 Hope，只是想开始养成电子记录的习惯，我更建议先比较其他适合作为长期个人档案的工具。

## 🍂 为什么做 Hope Archive？

最开始，我只是想把自己的日记好好保存下来。

> 🍂 **[传送门：为什么会有 Hope Archive？ →](docs/WHY_HOPE_ARCHIVE.md)**
>
> *读我读我读我。*

## 🌱 接下来想做什么？

Hope Archive 还没有做完。现在的很多功能已经可以使用，但无论是导出排版、搜索、AI，还是代码本身，都还有继续完善的空间。

> 🌱 **[传送门：Hope Archive 接下来想做什么？ →](docs/FUTURE.md)**
>
> *这里放一些正在做的，以及一些还只是想想的东西。*
...
早期规划文档描述了更广泛的未来功能。开发分支现有 AI 问答、回顾、时间线和已选日记工作流；可选 Hybrid 的状态见上方开发说明，不应把未来规划或实验指标当成已发布能力。
