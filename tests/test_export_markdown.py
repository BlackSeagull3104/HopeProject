...
class MarkdownTests(unittest.TestCase):
    ...
    def image(self, name='a.png', size=(200, 400)):
        ...
        Image.new('RGB', size, tuple(hashlib.sha256(name.encode()).digest()[:3])).save(path)
    ...
    def asset_name(self, name):
        return hashlib.sha256((self.root/'media'/name).read_bytes()).hexdigest() + Path(name).suffix
    ...
    def test_single_relative_image_dimensions_and_bytes(self):
        ...
        self.assertIn('src="assets/' + self.asset_name('a.png') + '"', text)
    ...
    def test_two_contiguous_images_across_blocks(self):
        ...
        self.assertLess(text.index(self.asset_name('a.png')), text.index(self.asset_name('b.png')))
    ...
    def test_text_and_whitespace_prevent_regrouping(self):
        ...
        for separator in ['Middle\n\n中文😀', '  \n']:
            ...
            start=text.index(self.asset_name('a.png')); middle=text.index(separator,start)
            self.assertLess(start,middle);self.assertLess(middle,text.index(self.asset_name('b.png')))
    ...
    def test_long_image_threshold_full_image_and_bytes(self):
        ...
        self.assertIn('src="assets/' + self.asset_name('long.png') + '"', html)
    ...
    def test_export_starts_with_heading_without_front_matter(self):
        ...
        self.assertIn('  原文\n\nEnglish 😀  ', rendered)
        self.assertIn('src="../../assets/' + self.asset_name('a.png') + '"', rendered)
