...
export function App() {
  ...
  const [diaryType, setDiaryType] = useState<DiaryType>("all")
  ...
  function start(event: FormEvent) {
    ...
    void action(async () => {
      ...
      const body =
        page === "archive"
          ? { beginDate, endDate, outputDir, diaryType }
          : {
              inputPath,
              archiveDir,
              outputDir: exportDir,
                ...
                <fieldset disabled={running} className="min-w-0 space-y-6">
                  <Field label="日记类型">
                    <select
                      ...
                      value={diaryType}
                      onChange={(e) =>
                        setDiaryType(e.target.value as DiaryType)
                      }
                    >
                  ...
                  <>
                    <div className="grid gap-4 text-sm sm:grid-cols-3">
                      ...
                      <p>
                        ...
                        新建 /{" "}
                        {(job.result.export || job.result.markdown)?.skipped}{" "}
                        跳过 /{" "}
